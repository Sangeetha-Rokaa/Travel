    ...
    <style>
        ...
        *::after {
        ...
        .hero-overlay {
            position: absolute;
            inset: 0;
            background: linear-gradient(to right, rgba(5, 15, 40, 0.65) 0%, rgba(5, 15, 40, 0.25) 60%, transparent 100%)
        }
...
<body>
    ...
    <section class="hero-section" id="home">
        <div class="hero-bg">
            <img src="{{ asset('images/himal.png') }}" alt="Sangeetha">
        ...
        <div class="hero-content">
            ...
            <p class="hero-description">A LAND OF MAJESTIC HIMALAYAS<br>RICH CULTURE &amp; ENDLESS ADVENTURE. Country
                known for its
            ...
            <div class="hero-buttons">
                <a href="#destinations" class="btn btn-primary btn-hero"><i class="fas fa-mountain"></i> Explore
                    Destinations</a>
            ...
            <div class="destinations-grid">
                <div class="destination-card">
                    <div class="card-image">
                        <img src="https://images.unsplash.com/photo-1501854140801-50d01698950b?w=600&q=80"
                            alt="Pokhara" loading="lazy">
                ...
                <div class="destination-card">
                    <div class="card-image">
                        <img src="https://images.unsplash.com/photo-1516091877740-fde016699f2c?w=600&q=80"
                            alt="Everest Region" loading="lazy">
                        <div class="card-overlay"></div>
                ...
                <div class="destination-card">
                    <div class="card-image">
                        <img src="https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=600&q=80"
                            alt="Annapurna Region" loading="lazy">
                        <div class="card-overlay"></div>
                ...
                <div class="destination-card">
                    <div class="card-image">
                        <img src="https://images.unsplash.com/photo-1582654291302-1f87f3c8ba61?w=600&q=80"
                            alt="Kathmandu" loading="lazy">
                        <div class="card-overlay"></div>
    ...
    <footer class="site-footer">
                    ...
                    <div class="footer-col footer-brand">
                        <div class="footer-logo">
                            <svg width="36" height="36" viewBox="0 0 40 40" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <polygon points="20,2 38,32 2,32" fill="none" stroke="#4A90D9"
                                    stroke-width="2.5" />
                        ...
                        <p class="footer-desc">Experience the magic of Nepal — from the towering Himalayas to ancient
                            temples and vibrant culture. Your dream adventure starts here.</p>
        ...
        <div class="footer-bottom">
            <div class="container">
                <p>&copy; 2026 Visit Nepal. All Rights Reserved. | Made with <i class="fas fa-heart"
                        style="color:#e05c5c;"></i> in Nepal by Ashupasu</p>
        ...
        document.querySelectorAll('.destination-card').forEach(card => {
            card.addEventListener('mousemove', function(e) {
                ...
                card.style.transform =
                    `translateY(-8px) rotateX(${(-y/40).toFixed(2)}deg) rotateY(${(x/40).toFixed(2)}deg)`;
            });
