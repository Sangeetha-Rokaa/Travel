        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(340px,1fr));gap:2rem;">
            ...
            <div style="background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.08);
                ...
                <div style="position:relative;height:240px;overflow:hidden;">
                    ...
                    <div style="position:absolute;inset:0;background:linear-gradient(180deg,transparent 40%,rgba(3,8,16,.8) 100%);"></div>
                    <span style="position:absolute;top:1rem;left:1rem;padding:5px 14px;border-radius:50px;
                ...
                <div style="padding:1.8rem;">
                    ...
                    <div style="display:flex;gap:1.5rem;flex-wrap:wrap;margin-bottom:1rem;">
                        <span style="display:flex;align-items:center;gap:6px;color:rgba(255,255,255,.5);font-size:.82rem;">
                            <i class="fas fa-calendar-alt" style="color:var(--nepal-gold);"></i> {{ $trek['days'] }} Days
                        </span>
                        <span style="display:flex;align-items:center;gap:6px;color:rgba(255,255,255,.5);font-size:.82rem;">
                            <i class="fas fa-mountain" style="color:var(--nepal-gold);"></i> {{ $trek['max_altitude'] }}
                        </span>
                        <span style="display:flex;align-items:center;gap:6px;color:rgba(255,255,255,.5);font-size:.82rem;">
                            <i class="fas fa-map-marker-alt" style="color:var(--nepal-gold);"></i> {{ $trek['start'] }}
                        </span>
                    </div>
                    ...
                    <div style="display:flex;justify-content:space-between;align-items:center;
                        ...
                        <div style="font-family:'Cinzel',serif;font-size:1.4rem;font-weight:700;color:var(--nepal-gold);">
                            ${{ number_format($trek['price']) }}
                            <span style="font-size:.75rem;color:rgba(255,255,255,.4);font-family:'Raleway',sans-serif;font-weight:400;">/ person</span>
                        </div>
                        <a href="{{ route('treks.show', $trek['slug']) }}" class="btn-primary" style="padding:10px 20px;font-size:.82rem;">
...
.trek-index-card:hover img { transform:scale(1.1); }
</style>
@endsection